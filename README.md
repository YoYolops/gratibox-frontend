...
Aiming to encourage the goodness inside of all human beings, this project offers the possibility to acquire multiple products that will make you wellbeing flourish. Sit tight and just wait while we prepare and sending eneverything to you. 😇
...
- What are your signature options?
 ...
 - What do I receive?
    - You can choose between this 3 options (soon wil be more):
        - Teas
        - Incenses
        - Organic Products
...
- Frontend
    ...
    - type "yarn i" to install dependencies;
    - type "yarn start" to run the application;
 To work properly, this project needs to be connected with its server. Therefore, we left it running on heroku. The frontend app will connect automatically with our provider so you don't have to worry with it.
